    ...
    *,
    ...
    for work_package in plan.work_packages:
        ...
        _append_event(
            ...
            SubagentEvent(
                ...
                delivered_conclusion=record.delivered_conclusion or record.last_note,
    ...
    _append_event(
        ...
        SubagentEvent(
            ...
            subagent_type="infrastructure",
            blocker_scope=profile.task_summary,
            research_focus=profile.task_summary,
            delivered_conclusion=plan.rationale if plan.should_expand else plan.no_split_reason,
    ...
    *,
    ...
    _append_event(
        ...
        SubagentEvent(
            ...
            research_focus=record.research_focus,
            delivered_conclusion=record.delivered_conclusion or summary,
            decision_impact=record.decision_impact,
    ...
    def _close_record(item: dict[str, Any], *, to_status: str, note: str) -> dict[str, Any]:
        ...
        _append_event(
            ...
            SubagentEvent(
                ...
                research_focus=str(item.get("research_focus", "")).strip() or None,
                delivered_conclusion=str(item.get("delivered_conclusion", "")).strip() or note,
    ...
    *,
    ...
    _append_event(
        ...
        SubagentEvent(
            ...
            research_focus=str(found.get("research_focus", "")).strip() or None,
            delivered_conclusion=str(found.get("delivered_conclusion", "")).strip() or summary,
    ...
    *,
    ...
    _append_event(
        ...
        SubagentEvent(
            ...
            research_focus=str(source.get("research_focus", "")).strip() or None,
            delivered_conclusion=str(source.get("delivered_conclusion", "")).strip() or summary,
