...
## 2026-03-31T16:15:19 | as_share_research_v1-20260331T161519
- 摘要: 晋级门阻塞： 最大回撤 48.67% 高于 30.00%。
- 根因: 最大回撤 48.67% 高于 30.00%。
- 纠偏动作: 先恢复可用的 frozen universe 和本地 bars，再重跑 dry-run cycle。
- 当前状态: 未修复

## 2026-04-01T03:57:19 | as_share_research_v1-20260401T035719
- 摘要: 晋级门阻塞： 最大回撤 48.67% 高于 30.00%。
- 根因: 最大回撤 48.67% 高于 30.00%。
- 纠偏动作: 先恢复可用的 frozen universe 和本地 bars，再重跑 dry-run cycle。
- 当前状态: 未修复

## 2026-04-01T04:11:43 | as_share_research_v1-20260401T041143
- 摘要: 晋级门阻塞： 最大回撤 48.67% 高于 30.00%。
- 根因: 最大回撤 48.67% 高于 30.00%。
- 纠偏动作: 先恢复可用的 frozen universe 和本地 bars，再重跑 dry-run cycle。
- 当前状态: 未修复
